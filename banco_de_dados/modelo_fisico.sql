...
INSERT INTO Instituicao (id_Inst, nomeFantasia, nomeAdministrador, email, telefone, cep, cidade, razaoSocial, cnpj, dataFundacao, capitalSocial, horaInicial, horaFinal, sobre, senha) VALUES
(1, 'Instituição Terra Verde', 'Felipe Alcênio', 'admin_a@instituicao.com', '1234-5678', '12345-678', 'São Paulo', 'Instituição A LTDA', '12.345.678/0001-90', '2000-01-01', 'R$ 100000.00', '08:00:00', '18:00:00','Nossos voluntários dedicam-se a projetos de conservação, limpeza de áreas naturais, plantio de árvores, reciclagem e educação ambiental.', MD5('Senha123')),
(2, 'Projeto Vida Nova', 'João Freitas', 'admin_b@instituicao.com', '9876-5432', '98765-432', 'Rio de Janeiro', 'Instituição B LTDA', '98.765.432/0001-21', '2005-05-05', 'R$ 200000.00', '09:00:00', '19:00:00', '', MD5('Senha123')),
(3, 'Instituição Cuidadora', 'Lucas Marcelo', 'admin_c@instituicao.com', '1111-2222', '11111-222', 'Belo Horizonte', 'Instituição C LTDA', '11.111.222/0001-33', '2010-10-10', 'R$ 300000.00', '10:00:00', '20:00:00', 'Nosso objetivo é promover a inclusão, o bem-estar e a dignidade de todos', MD5('Senha123')),
(4, 'Fundação Dia Felz', 'Rogério Ceni', 'admin_d@instituicao.com', '3333-4444', '33333-444', 'Curitiba', 'Instituição D LTDA', '33.333.444/0001-44', '2015-01-15', 'R$ 400000.00', '11:00:00', '21:00:00', '', MD5('Senha123')),
(5, 'Casa Bem Viver', 'Maria Estrela', 'admin_e@instituicao.com', '5555-6666', '55555-666', 'Salvador', 'Instituição E LTDA', '55.555.666/0001-55', '2020-03-20', 'R$ 500000.00', '12:00:00', '22:00:00', '', MD5('Senha123')),
(6, 'Projeto Educação', 'Márcia Silva', 'admin_f@instituicao.com', '7777-8888', '77777-888', 'Porto Alegre', 'Instituição F LTDA', '77.777.888/0001-66', '2003-08-30', 'R$ 600000.00', '13:00:00', '23:00:00', '', MD5('Senha123')),
(7, 'Fundação Zelo Eterno', 'Marcos Júnior', 'admin_g@instituicao.com', '9999-0000', '99999-000', 'Brasília', 'Instituição G LTDA', '99.999.000/0001-77', '2007-12-25', 'R$ 700000.00', '14:00:00', '00:00:00', 'Acreditamos que, através do cuidado e da solidariedade, podemos construir uma sociedade mais justa e igualitária.', MD5('Senha123')),
(8, 'Instituto Laço Amoroso', 'Joaquim Fênix', 'admin_h@instituicao.com', '2222-3333', '22222-333', 'Manaus', 'Instituição H LTDA', '22.222.333/0001-88', '2012-06-15', 'R$ 800000.00', '15:00:00', '01:00:00', 'Nosso objetivo é promover o cuidado responsável e a proteção dos direitos dos animais por meio de programas de voluntariado que envolvem resgate, reabilitação e adoção.', MD5('Senha123')),
(9, 'Instituição Fidalgo', 'Mac DeMarco', 'admin_i@instituicao.com', '4444-5555', '44444-555', 'Recife', 'Instituição I LTDA', '44.444.555/0001-99', '2018-09-05', 'R$ 900000.00', '16:00:00', '02:00:00', '', MD5('Senha123')),
(10, 'Projeto Vida Animal', 'Roger Waters', 'admin_j@instituicao.com', '6666-7777', '66666-777', 'Belém', 'Instituição J LTDA', '66.666.777/0001-10', '2000-02-20', 'R$ 1000000.00', '17:00:00', '03:00:00', 'Acreditamos que todos os animais merecem amor e respeito, e trabalhamos diariamente para garantir um futuro melhor para eles.', MD5('Senha123')),
(11, 'Fundação Patas Felizes', 'Charles Maicon', 'admin_k@instituicao.com', '8888-9999', '88888-999', 'Porto Velho', 'Instituição K LTDA', '88.888.999/0001-11', '2005-05-10', 'R$ 1100000.00', '18:00:00', '04:00:00', 'Junte-se a nós e faça a diferença na vida dos animais!', MD5('Senha123')),
(12, 'Instituição Terra Viva', 'Henrique Jackson', 'admin_l@instituicao.com', '0000-1111', '00000-111', 'Florianópolis', 'Instituição L LTDA', '00.000.111/0001-12', '2010-10-30', 'R$ 1200000.00', '19:00:00', '05:00:00', 'Acreditamos que cada ação conta e que juntos podemos fazer uma diferença significativa para o planeta.', MD5('Senha123')),
(13, 'Projeto Sorriso', 'Silveira Júnior', 'admin_m@instituicao.com', '2222-3333', '22222-333', 'São Luís', 'Instituição M LTDA', '22.222.333/0001-13', '2015-03-25', 'R$ 1300000.00', '20:00:00', '06:00:00', '', MD5('Senha123')),
(14, 'Projeto Saber', 'Jaques Oliveira', 'admin_n@instituicao.com', '4444-5555', '44444-555', 'Goiânia', 'Instituição N LTDA', '44.444.555/0001-14', '2020-04-15', 'R$ 1400000.00', '21:00:00', '07:00:00', 'Nosso objetivo é capacitar indivíduos e comunidades por meio de programas de voluntariado que proporcionam suporte educacional.', MD5('Senha123')),
(15, 'Instituto Jovem', 'Roberta Pereira', 'admin_o@instituicao.com', '6666-7777', '66666-777', 'João Pessoa', 'Instituição O LTDA', '66.666.777/0001-15', '2003-09-10', 'R$ 1500000.00', '22:00:00', '08:00:00', '', MD5('Senha123')),
(16, 'Projeto Companhia', 'Oruan Reinaldo', 'admin_p@instituicao.com', '8888-9999', '88888-999', 'Maceió', 'Instituição P LTDA', '88.888.999/0001-16', '2007-11-20', 'R$ 1600000.00', '23:00:00', '09:00:00', '', MD5('Senha123')),
(17, 'Instituição Chaves', 'Isabela Moreira', 'admin_q@instituicao.com', '0000-1111', '00000-111', 'Palmas', 'Instituição Q LTDA', '00.000.111/0001-17', '2012-04-05', 'R$ 1700000.00', '00:00:00', '10:00:00', '', MD5('Senha123')),
(18, 'Fundação Igualdade', 'Ednaldo Pereira', 'admin_r@instituicao.com', '2222-3333', '22222-333', 'Teresina', 'Instituição R LTDA', '22.222.333/0001-18', '2018-06-15', 'R$ 1800000.00', '01:00:00', '11:00:00', '', MD5('Senha123')),
