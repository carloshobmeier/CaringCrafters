      ...
      switch (element.dataset.type) {
        ...
        case "cpf":
          isValidCPF(element.value)
            ? element.classList.remove("wrong")
            : element.classList.add("wrong");
            errorPhrase = "CPF inválido. Inserir segundo um dos modelos: 000.000.000-00 ou 00000000000.";
        ...
        case "cep":
          isValidCEP(element.value)
            ? element.classList.remove("wrong")
            : element.classList.add("wrong");
            errorPhrase ="CEP inválido. Inserir segundo um dos modelos: 00000-000 ou 00000000.";
        ...
        case "password":
          isValidPassword(element.value)
            ? element.classList.remove("wrong")
            : element.classList.add("wrong");
            errorPhrase ="Sua senha precisa conter oito ou mais caracteres, com pelo menos uma letra maiúscula e um número.";
