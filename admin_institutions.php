                        ...
                        <td>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                ...
                                <div class="modal-footer mx-auto">
                                    ...
                                    <a onclick="deleteItem(<?php echo $row['id_Inst'] ?>)"><button type="button" class="btn btn-success">Sim</button></a>
                                </div>
                                </div>
                            </div>
                            </div>
        ...
        swal.fire({
                ...
                icon: "success",
                    ...
                    if(result.isConfirmed){
                        location.href = "banco_de_dados/adminRemoveInstitution_php.php?id=" + id
