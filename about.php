  ...
  <div class="container" style="margin-top:40px; margin-bottom:40px">
    <div class="row">
      ...
      <div class="col-md-6 esquerda">
        ...
        <p>Nossa história começa em 2024, impulsionada por um ideal simples: cada gesto de bondade tem o poder de transformar o mundo. A partir desse princípio, embarcamos em uma jornada para unir corações apaixonados a oportunidades de causar <span>impacto social</span>.</p>
...
<div class="col-md-6 esquerda">
        ...
        Estes são os valores que nos definem como CaringCrafters. Eles nos inspiram a aspirar ao melhor e nos lembram do compromisso que temos com a construção de um mundo mais solidário, justo e inclusivo para todos.
